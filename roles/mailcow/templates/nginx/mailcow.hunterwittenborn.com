server {
  ...
  ssl_certificate /etc/letsencrypt/live/mailcow.hunterwittenborn.com/fullchain.pem;
  ssl_certificate_key /etc/letsencrypt/live/mailcow.hunterwittenborn.com/privkey.pem;
}
