...
- name: Copy ProGet service files
  ansible.builtin.template:
    ...
    mode: "{{ item.mode }}"
  loop: [
    {"src": "proget/docker-compose.yml.j2", "dest": "/var/www/proget.hunterwittenborn.com/docker-compose.yml", "owner": "root", "mode": "600"},
    {"src": "proget/service.sh.j2", "dest": "/var/www/proget.hunterwittenborn.com/service.sh", "owner": "root", "mode": "755"}
  ]
